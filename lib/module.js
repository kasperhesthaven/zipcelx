...
var validator = e =>
  e.filename
    ? "string" != typeof e.filename
      ...
      ? !!childValidator(e.sheet.data) ||
        (console.error(INVALID_TYPE_SHEET_DATA), !1)
...
var generatorCellNumber = (e, o) => `${generateColumnLetter(e)}${o}`,
  generatorStringCell = (e, o, t) =>
    `<c r="${generatorCellNumber(e, t)}" t="inlineStr"><is><t>${escape(
      o
    )}</t></is></c>`,
  generatorNumberCell = (e, o, t) =>
    `<c r="${generatorCellNumber(e, t)}"><v>${o}</v></c>`,
  formatCell = (e, o, t) => (
    -1 === validTypes.indexOf(e.type) &&
      (console.warn(WARNING_INVALID_TYPE), (e.type = "string")),
    "string" === e.type
      ? generatorStringCell(o, e.value, t)
      : generatorNumberCell(o, e.value, t)
  ),
  formatRow = (e, o) => {
    const t = o + 1,
